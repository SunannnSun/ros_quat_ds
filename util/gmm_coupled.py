...
from .gmm import gmm as gmm_uncoupled
...
class gmm:
    ...
    def _dual_gmm(self):
            ...
            q_normal_list_dual.append(
                {
                    "mu"    : Mu[1],
                    "sigma" : Sigma[3:, 3:],
                    "rv"    : multivariate_normal(np.zeros((4 )), Sigma[3:, 3:], allow_singular=True)
                }
            )
        ...
        dual_gmm = gmm_uncoupled([], self.q_att)
        dual_gmm.K = K_dual
